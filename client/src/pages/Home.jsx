...
const ASSETS = { hero: "/assets/starhustler-hero-founder_7e51a4c1.webp", about: "/assets/starhustler-about-founders_9d74897f.webp", andre: "/assets/andre-founder_a326359d.svg", septianus: "/assets/septianus-founder_fe165f47.svg", maleOffice: "/assets/starhustler-japanese-male-office_b8ef0e79.webp", femaleOffice: "/assets/starhustler-japanese-female-office_e90ae59e.webp", faqWoman: "/assets/starhustler-faq-woman-white-office_22159a27.webp", ebookMockup: "/assets/starhustler-solopreneur-starter-kit-mockup_f0ada996.webp", benefit: "/assets/starhustler-benefits-mentor_fdf27b2f.webp", courses: "/assets/starhustler-course-creators_4af6efe2.webp" };
const PARTNER_LOGOS = { ChatGPT: "/assets/chatgpt_2f93ed0f.png", Claude: "/assets/claude_febe1a79.png", Cursor: "/assets/cursor_7e8b7fa2.png", Lovable: "/assets/lovable_a9d88ba1.png", Higgsfield: "/assets/higgsfield_f82249bd.png" };
const programs = [
  ...
  return (
    <div className="site-page">
      ...
      <main>
        ...
        <section className="faq-section section-shell" id="faq"><div className="faq-copy"><SectionHeading title="Frequently Asked Questions" /><div className="faq-list">{faqs.map(([question, answer], index) => { const isOpen = openFaq === index; return <article className={`faq-item ${isOpen ? "faq-item--open" : ""}`} key={question}><button onClick={() => setOpenFaq(isOpen ? -1 : index)} aria-expanded={isOpen}><span className="faq-number">{String(index + 1).padStart(2, "0")}</span><span>{question}</span><ChevronDown size={19} /></button>{isOpen && <div className="faq-answer"><p>{answer}</p></div>}</article>; })}</div></div><aside className="faq-aside"><div className="faq-portrait"><img src={ASSETS.faqWoman} alt="Office employee in a bright workspace" /></div><span className="faq-spark faq-spark--one">✦</span><span className="faq-spark faq-spark--two">✦</span></aside></section>

        <section className="ebook-section" id="ebook"><div className="ebook-shell"><div className="ebook-copy"><p className="ebook-label">Ebook Gratis</p><h2>Solopreneur <span>Starter Kit</span></h2><p className="ebook-kicker"><BookOpen size={18} /> Ditulis oleh <strong>Andre Elausta Tuwan</strong></p><p>Pelajari langkah awal membangun usaha sendiri, mulai dari menemukan ide sampai berani mengambil keputusan pertama. Ebook ini merangkum pengalaman Andre keluar dari dunia perbankan dan membangun jalannya sendiri sebagai solopreneur.</p><form onSubmit={subscribe} className="ebook-form"><label className="sr-only" htmlFor="ebook-email">Enter your email address</label><input id="ebook-email" required type="email" placeholder="Enter your email address" /><button type="submit">Download Ebook <Send size={15} /></button></form></div><div className="ebook-mockup"><div className="ebook-mockup__halo" aria-hidden="true" /><img src={ASSETS.ebookMockup} alt="Solopreneur Starter Kit ebook by Andre Elausta Tuwan" /></div></div></section>
